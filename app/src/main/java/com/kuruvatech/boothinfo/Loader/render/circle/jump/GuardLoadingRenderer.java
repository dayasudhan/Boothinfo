package com.kuruvatech.boothinfo.Loader.render.circle.jump;
...
import com.kuruvatech.boothinfo.Loader.DensityUtil;
import com.kuruvatech.boothinfo.Loader.render.LoadingRenderer;
...
public class GuardLoadingRenderer extends LoadingRenderer {
    ...
    //radious and color
    private static final float DEFAULT_CENTER_RADIUS = 5f;
    private static final float DEFAULT_SKIP_BALL_RADIUS = 0.50f;
